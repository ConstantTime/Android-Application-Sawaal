...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView profileemail = header.findViewById(R.id.profileemailnv);
        ...
        Picasso.with(getApplicationContext()).load(auth.getCurrentUser().getPhotoUrl()).fit().into(profileimg);
